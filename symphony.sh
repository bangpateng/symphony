...
curl -Ls https://filex.bangpateng.xyz/snapshot/symphony/genesis.json > $HOME/.symphonyd/config/genesis.json
curl -Ls https://filex.bangpateng.xyz/snapshot/symphony/addrbook.json > $HOME/.symphonyd/config/addrbook.json
